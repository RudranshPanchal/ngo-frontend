...
//   //       const res = await fetch(`${BACKEND}/api/member/${id}`);
...
//                   <span>
//                     {member.address
//                       ? `${member.address}${member.area ? ", " + member.area : ""}`
//                       : "No address"}
//                   </span>
//                 </div>
//               </div>
...
//                   <p className="capitalize">{member.gender || "Not specified"}</p>
//                 </div>
//                 <div>
//                   <label className="text-sm text-gray-500">Age</label>
//                   <p>{member.age ? `${member.age} years` : "Not specified"}</p>
//                 </div>
//                 <div>
...
//               <CardContent className="space-y-4">
//                 <div>
//                   <label className="text-sm text-gray-500">Types of Support</label>
//                   <p>
//                     {member.typesOfSupport?.length
//                       ? member.typesOfSupport.join(", ")
//                       : "Not specified"}
//                   </p>
//                 </div>
//                 <div>
...
//                     Special Requirement
//                   </label>
//                   <p>{member.specialRequirement || "None"}</p>
//                 </div>
//               </CardContent>
//             </Card>
//           </div>
...
const MemberDetailPage = () => {
  ...
  const fetchMember = async () => {
    try {
      ...
      setMember(res.data.member || res.data.data || res.data);
    } catch (err) {
      console.error("Fetch member error:", err);
      setMember(null);
    } finally {
            ...
            <Card className="bg-white shadow-sm border-0">
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-gray-900">
                    {member.specialRequirement || "None"}
                  </p>
                </div>
              </CardContent>
            </Card>
